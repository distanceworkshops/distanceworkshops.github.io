---
title: Workshop - camera trap distance sampling, March 2022
layout: index

---

# Online workshop: analysis of camera trap data with distance sampling, March 2022
...
The training workshop is intended to teach the fundamental principles of design and analysis of animal abundance using data derived from camera traps. In association with the principles, computer exercises will guide participants through survey design, fitting detection functions to detections, performing model selection, estimating temporal availability of animals and computing measures of uncertainty. This is the second of a pair of planned workshops, with the first having taken place in October 2021.  During the first workshop the R software was used for design and analysis. The March 2022 workshop will resemble the first, except that the Distance for Windows software will be used to generate designs and perform analyses.  The training workshop is intended to teach the fundamental principles of design and analysis of animal abundance using data derived from camera traps.
...
21st -- 25th March 2022, 14:00-17:00 UK time.  To find the time in your location, follow [this link](https://www.timeanddate.com/worldclock/fixedtime.html?msg=Camera+trap+distance+sampling+workshop&iso=20220321T14&p1=3853&ah=3) to a universal time converter.
...
The workshop will be a mix of live online interactive sessions, delivered via videoconference software (Microsoft Teams) and computer exercises.   There will be four sessions, across five days, each lasting three hours. In addition, there will be practical exercises to be undertaken outside of the scheduled sessions.  The practicals will be carried out using Distance for Windows software, enhanced to analyse camera trapping data.
...
You should already understand distance sampling concepts, for example by having taken a face-to-face introductory workshop or an online workshop (either interactive or via our [free pre-recorded lectures](https://workshops.distancesampling.org/online-course/)).  

## Registration and Payment

The Registration Fee is 270GBP.  Registration is now open via the [Univ of St Andrews Online Shop](https://onlineshop.st-andrews.ac.uk/conferences-and-events/events/creem/online-workshop-analysis-of-camera-trap-data-with-distance-sampling-21st-25th-march-2022). Registration deadline is 11 February 2022.
